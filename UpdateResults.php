	...
	<div>
		...
		<div id="text">
    		...
    		<table class="table table-dark">
        		...
        		<tbody id="studentTable">
            		<?php
                		...
                		if(isset($_POST["ID"]) && isset($_POST["Code"])&& isset($_POST["Place"])&& isset($_POST["Score"])&& isset($_POST["Time"])){
                    		// get all our student data
                    		$code1 = mysqli_real_escape_string($conn, $_POST['ID']);
                    		$code2 = mysqli_real_escape_string($conn, $_POST['Code']);
                    		$code3 = mysqli_real_escape_string($conn, $_POST['Place']);
                    		$code4 = mysqli_real_escape_string($conn, $_POST['Score']);
                    		$code5 = mysqli_real_escape_string($conn, $_POST['Time']);
                
                    		$query = "INSERT INTO Register VALUES($code1, $code2, $code3, $code4, $code5);"; 
            		...
            		<?php
                		...
                		if(isset($_POST["ID"]) && isset($_POST["Code"])&& isset($_POST["Place"])&& isset($_POST["Score"])&& isset($_POST["Time"])){
                    		...
                    		$query = "SELECT * FROM Register WHERE AthleteID = $code1 AND EventCode = $code2;";
                    		$result = mysqli_query($conn, $query);
    		...
    		<form action="" method="post">
    			Input AthleteID below: <br />
    			<input type="text" name="ID"/>
    			<br /><br />
    			Input EventCode below: <br />
    			<input type="text" name="Code"/>
    			<br /><br />
    			Input Place below: <br />
    			<input type="text" name="Place"/>
    			<br /><br />
    			Input Score below: <br />
    		...
    		<table class="table table-dark">
        		<thead>
            		<tr>
                		...
                		<th scope="col">Is_end</th>
                		<th scope="col">WorldRecord</th>
        		...
        		<tbody id="studentTable">
            		<?php
                		...
                		if(isset($_POST["EventCode"]) && isset($_POST["WorldRecord"])){
                    		// get all our student data
                    		$code6 = mysqli_real_escape_string($conn, $_POST['EventCode']);
                    		$code7 = mysqli_real_escape_string($conn, $_POST['WorldRecord']);
                
                    		$query = "UPDATE Event SET WorldRecord = $code7 WHERE EventCode = $code6;"; 
               				$result = mysqli_query($conn, $query);
                		}
            		?>
            		<?php
                		...
                		if(isset($_POST["EventCode"]) && isset($_POST["WorldRecord"])){
                    		...
                    		$query = "SELECT * FROM Event WHERE EventCode = $code6;";
                    		$result = mysqli_query($conn, $query);
                    		// put all our results into a html table
                    		while ($rows = mysqli_fetch_array($result)) {
                        		echo "<tr>";
                        		...
                        		echo "<td>".$rows["Is_end"]."</td>";
                        		echo "<td>".$rows["WorldRecord"]."</td>";                        		
                        		echo "</tr>";
                    		}
                		}
            		?>
			...
			<form action="" method="post">
    			...
    			<br /><br />
    			Input new WorldRecord below: <br />
    			<input type="text" name="WorldRecord"/>
    			<br /><br />
    			<input type="submit" value="submit" />
    		</form>
		</div>
