        		...
        		<tbody id="studentTable">
            		<?php
                		...
                		if(isset($_POST["First"]) && isset($_POST["Last"])&& isset($_POST["Gender"])&& isset($_POST["Age"])&& isset($_POST["Number"])&& isset($_POST["ID"])){
                    		...
                    		$query = "UPDATE Coordinator SET FirstName = \"$code1\", LastName = \"$code2\", Gender = \"$code3\", Age = $code4, PhoneNumber = $code5 WHERE CoordinatorID = $code6;"; 
            		...
            		<?php
                		...
                		if(isset($_POST["First"]) && isset($_POST["Last"])&& isset($_POST["Gender"])&& isset($_POST["Age"])&& isset($_POST["Number"])&& isset($_POST["ID"])){
                    		...
                    		$query1 = "SELECT FirstName, LastName, Gender, Age, PhoneNumber FROM Coordinator WHERE CoordinatorID = $code6;";
