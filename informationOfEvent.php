...
<body>
	<div>
		...
		<div id="text">
            		...
            		<?php
                		// FILL TABLE WITH DATA ON CLICK
                    		...
                    		while ($rows = mysqli_fetch_array($result)) {
                        		...
                        		echo "<td>".$rows["Seating_capacity"]."</td>";
                        		echo "</tr>";
                    		}
    		...
    		<h6>Check if a venue has been used for an event at a particular time</h6>
        		...
        		<tbody id="studentTable">
            		<?php
                		...
                		if(isset($_POST["name"]) && isset($_POST["date"])){
                    		// get all our student data
                    		$code2 = mysqli_real_escape_string($conn, $_POST['name']);
                    		$code3 = mysqli_real_escape_string($conn, $_POST['date']);
                    		$query = "SELECT * From Temp WHERE VenueName = \"$code2\" AND Date = \"$code3\"" ;
                    		$result = mysqli_query($conn, $query);
                    		// put all our results into a html table
                    		while ($rows = mysqli_fetch_array($result)) {
                        		echo "<tr>";
