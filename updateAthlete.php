...
<body>
	<div>
		...
		<div id="text">
        		...
        		<tbody id="studentTable">
            		<?php
                		...
                		if(isset($_POST["First"]) && isset($_POST["Last"])&& isset($_POST["Gender"])&& isset($_POST["Age"])&& isset($_POST["Number"])&& isset($_POST["ID"])){
                    		...
                    		$query = "UPDATE Athlete SET FirstName = \"$code1\", LastName = \"$code2\", Gender = \"$code3\", Age = $code4, PhoneNumber = $code5 WHERE AthleteID = $code6;"; 
            		...
            		<?php
                		...
                		if(isset($_POST["First"]) && isset($_POST["Last"])&& isset($_POST["Gender"])&& isset($_POST["Age"])&& isset($_POST["Number"])&& isset($_POST["ID"])){
                    		...
                    		$query1 = "SELECT FirstName, LastName, Gender, Age, PhoneNumber FROM Athlete WHERE AthleteID = $code6;";
    		...
    		<br />
    		<h4>
    			Delete the information of a certain athlete.
    		</h4>
    		<br />
        		...
        		<tbody id="studentTable">
            		<?php
                		...
                		if(isset($_POST["delete"])){
                   		 	// get all our student data
                    		$code8 = mysqli_real_escape_string($conn, $_POST['delete']);
                   
                    		$query3 = "DELETE FROM Athlete WHERE AthleteID = $code8;";
            		...
            		<?php
                		...
                		if(isset($_POST["delete"])){
                    		...
                    		$query4 = "SELECT * FROM AthleteInTeam WHERE TeamCode = 310;";
    		...
    		<form action="" method="post">
    			Input the athleteID you want to delete: <br />
