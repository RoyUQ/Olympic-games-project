    		...
    		<table class="table table-dark">
        		...
        		<tbody id="studentTable">
            		<?php
                		...
                		if(isset($_POST["First"]) && isset($_POST["Last"])&& isset($_POST["Gender"])&& isset($_POST["Age"])&& isset($_POST["Number"])&& isset($_POST["ID"])&& isset($_POST["Code"])){
                    		...
                    		$code7 = mysqli_real_escape_string($conn, $_POST['Code']);
                    		$query = "UPDATE WorksForStaff SET FirstName = \"$code1\", LastName = \"$code2\", Gender = \"$code3\", Age = $code4, PhoneNumber = $code5 WHERE StaffID = $code6 AND TeamCode = $code7;"; 
            		...
            		<?php
                		...
                		if(isset($_POST["First"]) && isset($_POST["Last"])&& isset($_POST["Gender"])&& isset($_POST["Age"])&& isset($_POST["Number"])&& isset($_POST["ID"])&& isset($_POST["Code"])){
                    		...
                    		$query = "SELECT FirstName, LastName, Gender, Age, PhoneNumber FROM WorksForStaff WHERE StaffID = $code6 AND TeamCode = $code7;";
                    		$result = mysqli_query($conn, $query);
